...
.method public static callInTransaction(Lcom/j256/ormlite/support/DatabaseConnection;ZLcom/j256/ormlite/db/DatabaseType;Ljava/util/concurrent/Callable;)Ljava/lang/Object;
    ...
    invoke-virtual {v3, v4}, Lcom/j256/ormlite/logger/Logger;->debug(Ljava/lang/String;)V
    :try_end_2
    ...
    const-string v4, "after commit exception, rolling back to save-point also threw exception"

    invoke-virtual {v3, v0, v4}, Lcom/j256/ormlite/logger/Logger;->error(Ljava/lang/Throwable;Ljava/lang/String;)V
    :try_end_6
    ...
    :goto_4
    :try_start_8
    const-string v3, "Transaction callable threw non-SQL exception"
